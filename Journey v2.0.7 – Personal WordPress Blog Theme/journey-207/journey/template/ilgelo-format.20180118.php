<?php
	...
	function ilgelo_format_metapost($template) {
		...
		$output.=__("By", "ilgelo")." <b> ".get_the_author_posts_link()." </b> ";
		$output.="</div>";
		$output.="<div class='indie_on'>";
		$output.="".__("on", "ilgelo")." ";
		$output.="</div>";
		$output.="<div class='indie_date'>";
...
$output.="<a data-pin-do='skipLink' target='_blank' href='https://pinterest.com/pin/create/button/?url=".get_the_permalink()."&media=".$pin_image."&description=".get_the_title()."'>";
